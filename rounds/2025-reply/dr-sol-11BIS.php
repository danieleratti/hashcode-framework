...
for ($t = 0; $t < $turnsCount; $t++) {
    ...
    if ($poweredByResources < $finalMinB) {
        ...
        if($capital > 1000000) {
            ...
            for($i=0;$i<min(20, round($capital/550));$i++) {
                $addedIds[] = 27;
            }
            for($i=0;$i<min(20, round($capital/180));$i++) {
                $addedIds[] = 37;
            }
            for($i=0;$i<min(30, round($capital/400));$i++) {
                $addedIds[] = 20;
            }
        ...
        elseif($capital > 1000) {
            ...
            for($i=0;$i<min(10, round($capital/180));$i++) {
                $addedIds[] = 37;
            }
            for($i=0;$i<min(10, round($capital/550));$i++) {
                $addedIds[] = 27;
            }
            for($i=0;$i<min(30, round($capital/400));$i++) {
                $addedIds[] = 20;
