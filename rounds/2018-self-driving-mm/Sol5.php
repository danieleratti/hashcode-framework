            ...
            */
            ...
            foreach ($nextVehicles as $vehicle) {
                ...
                foreach ($this->rides as $currentRide) {
                    ...
                    $distanceFromCenter = distanceBetween($currentRide->finishRow, $currentRide->finishColumn, 2779, 1055);
                    $radius = 2800;
                    $malus = $distanceFromCenter > $radius ? ($distanceFromCenter - $radius) : 0;
                    $score = ($simulation->revenue - $malus) / $simulation->timeTaken;
