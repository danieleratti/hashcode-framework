...
$takeN = 300;
$ordering = 0;
Cerberus::runClient(['fileName' => $fileName, 'takeN' => $takeN, 'ordering' => $ordering]);
Autoupload::init();
...
switch ($ordering) {
    case 0: // SKIP
        ...
        break;
    case 1:
        $orderedSpeedAntennas = $C_ANTENNAS->sortBy('speed');
        break;
    case 2:
        $orderedSpeedAntennas = $C_ANTENNAS->sortByDesc('range');
        break;
    case 3:
        $orderedSpeedAntennas = $C_ANTENNAS->sortBy('range');
        break;
}
