...
while(true) {
    ...
    /*
    $takenIngredientsToRelease = $takenIngredients;
    ArrayUtils::array_keysort_objects($takenIngredientsToRelease, 'importance', SORT_ASC);
    $takenIngredientsToRelease = array_splice($takenIngredientsToRelease, 0, 10);
    $toRelease = $takenIngredientsToRelease[array_rand($takenIngredientsToRelease, 1)];

    $freeIngredientsToTake = $freeIngredients;
    ArrayUtils::array_keysort_objects($freeIngredientsToTake, 'importance', SORT_DESC);
    $freeIngredientsToTake = array_splice($freeIngredientsToTake, 0, 10);
    $toTake = $freeIngredientsToTake[array_rand($freeIngredientsToTake, 1)];
    */
