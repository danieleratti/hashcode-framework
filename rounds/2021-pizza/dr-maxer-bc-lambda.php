...
while($TEAMS[2] > 0 && $PIZZAS->count() >= 2) shipBestCombination(2);
while($TEAMS[4] > 0 && $PIZZAS->count() >= 4) shipBestCombination(4);
while($TEAMS[3] > 0 && $PIZZAS->count() >= 3) shipBestCombination(3);
